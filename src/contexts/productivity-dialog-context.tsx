...
export function ProductivityDialogProvider({ children }: ProviderProps) {
...
export function useIsOpen() {
  ...
  if (context === null) {
    throw new Error(
      "useIsOpen has to be used within <ProductivityDialogProvider />",
    );
  }
...
export function useSetIsOpen() {
  ...
  if (context === null) {
    throw new Error(
      "useSetIsOpen has to be used within <ProductivityDialogProvider />",
    );
  }
