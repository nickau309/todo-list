...
export default function UnlockLocationDialog({
  children,
  disabled = false,
}: DialogProps) {
...
export function useUnlockLocationDialog(component: string) {
  const context = useContext(DialogContext);

  if (context === null) {
    throw new Error(
      `<${component} /> is missing a parent <UnlockLocationDialog /> component.`,
    );
  }
