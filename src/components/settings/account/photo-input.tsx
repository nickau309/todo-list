...
export default function PhotoInput({ disabled, name }: PhotoInputType) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <h3 className="truncate font-bold">Photo</h3>
        ...
        <div className="flex min-w-0 flex-col items-start gap-2">
          ...
          <div>
            <button
              ...
              className={clsx(
                "flex h-8 min-w-[68px] cursor-pointer select-none items-center justify-center rounded-[5px] border border-transparent",
